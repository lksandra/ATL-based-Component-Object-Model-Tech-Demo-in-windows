...
//	if (dir.size() == 0)
//		return dirs;
//	if (dir.compare(".") != 0 && dir.compare("..") != 0 && dir.compare(".vs") != 0)
//	{
//		specdir = Path::fileSpec(path, dir);
//		dirs.push_back(specdir);
//	}
//	while (true)
//	{
//		dir = fss.nextDirectory();
...
int main(int argc, char* argv[])
{
  ...
  */
  ...
  //S:
  std::string fp = "C:/Users/RAJESH/Documents/vs 2017 projects before uninstalling on 27th march 1150pm/Projects/SMAprojects";
  Directory::setCurrentDirectory(fp);


  std::cout << "\n  current directory is:\n    " << Directory::getCurrentDirectory();
  std::cout << "\n  It contains files:";
  std::vector<std::string> currfiles = Directory::getFiles(".", "*.txt");
  ///////////////////////////////////////////////////////
  // This works too
  ...
  for(size_t i=0; i<currdirs.size(); ++i)
    std::cout << "\n    " << Path::getFullFileSpec(currdirs[i]).c_str();
  std::cout << "\n";
  ...
  auto currdirtemp = Directory::getCurrentDirectory();
  std::cout << currdirtemp << std::endl;
